...
(function (ReactXP) {
    ...
    var windowsAnimatedClasses = __assign({}, Animated_1.CommonAnimatedClasses, { View: RN.Animated.createAnimatedComponent(View_1.default), TextInput: RN.Animated.createAnimatedComponent(TextInput_1.default) });
