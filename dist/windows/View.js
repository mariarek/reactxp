...
var FocusManager_2 = require("../native-desktop/utils/FocusManager");
...
var View = /** @class */ (function (_super) {
    ...
    View.prototype.hasTrait = function (trait, traits) {
    ...
    View.prototype._buildInternalProps = function (props) {
        ...
        var hasGroup = this.hasTrait(Types.AccessibilityTrait.Group, props.accessibilityTraits);
        var hasDialog = this.hasTrait(Types.AccessibilityTrait.Dialog, props.accessibilityTraits);
        var i4aYes = props.importantForAccessibility === Types.ImportantForAccessibility.Yes;
        var i4aAuto = (props.importantForAccessibility === Types.ImportantForAccessibility.Auto
    ...
    View.childContextTypes = __assign({ isRxParentAText: PropTypes.bool.isRequired, focusManager: PropTypes.object, popupContainer: PropTypes.object, isRxParentAContextMenuResponder: PropTypes.bool }, View_1.View.childContextTypes);
    return View;
}(View_1.View));
exports.View = View;
