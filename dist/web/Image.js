...
var Image = /** @class */ (function (_super) {
    ...
    Image.prototype._actuallyStartXhrImageFetch = function (props) {
        ...
        if (props.headers && Object.keys(props.headers).some(function (header) { return header.toLowerCase() === 'origin'; })) {
    ...
    Image.prototype.render = function () {
        ...
        if (this.state.showImgTag) {
            optionalImg = (React.createElement("img", { style: _styles.image, src: this.state.displayUrl, alt: this.props.accessibilityLabel, onLoad: this._onLoad, onError: this._imgOnError, ref: this._onMount }));
        }
