...
var GestureView = /** @class */ (function (_super) {
    ...
    function GestureView(props) {
        ...
        _this._panResponder = RN.PanResponder.create({
            onStartShouldSetPanResponder: function (e, gestureState) {
                ...
                if (_this.props.onTap || _this.props.onDoubleTap || _this.props.onContextMenu) {
                    return true;
                }
                return false;
            },
    ...
    GestureView.prototype._shouldRespondToPan = function (gestureState) {
        ...
        var panThreshold = (!_.isUndefined(this.props.panPixelThreshold) && this.props.panPixelThreshold > 0) ?
    ...
    GestureView.prototype.render = function () {
        ...
        return (React.createElement(RN.View, __assign({ style: [ViewBase_1.default.getDefaultViewStyle(), this.props.style], importantForAccessibility: importantForAccessibility, accessibilityTraits: accessibilityTrait, accessibilityComponentType: accessibilityComponentType, accessibilityLabel: this.props.accessibilityLabel }, this._panResponder.panHandlers), this.props.children));
    };
    return GestureView;
}(React.Component));
