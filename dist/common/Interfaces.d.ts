...
export declare abstract class AnimatedImage extends AnimatedComponent<Types.AnimatedImageProps, Types.Stateless> {
}
export declare abstract class AnimatedText extends AnimatedComponent<Types.AnimatedTextProps, Types.Stateless> {
}
...
export declare abstract class Button extends React.Component<Types.ButtonProps, any> implements FocusableComponent {
    abstract focus(): void;
    abstract requestFocus(): void;
    abstract blur(): void;
}
...
export declare abstract class Link extends React.Component<Types.LinkProps, any> implements FocusableComponent {
    abstract focus(): void;
    abstract requestFocus(): void;
    abstract blur(): void;
}
...
export declare abstract class Text extends React.Component<Types.TextProps, any> implements FocusableComponent {
    abstract focus(): void;
    abstract requestFocus(): void;
    abstract blur(): void;
}
export declare abstract class TextInput extends React.Component<Types.TextInputProps, any> implements FocusableComponent {
